...
Assumed **active low** (pin driven LOW lights it), from the rest of the XIAO
family. Never verified on either board.
...
- `scan: N APs` should show a plausible count. On a C5 it should include
  5 GHz — `scan: 28 APs (13 on 2.4 GHz, 15 on 5 GHz)`. **A C6 is 2.4 GHz only**,
